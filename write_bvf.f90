      subroutine write_bvf(nx,ny,nz,nt,X,Y,Z,T,missing_value,pres)
      
      use netcdf 

      implicit none      

      character(len=*), parameter :: file_out="output_bvf.nc"
      ...
      character(len=*), parameter :: pres_NAME="n2"
      ...
      character(len=*), parameter :: pres_UNITS="s^-2"
